...
public class ContentS3ApiConstants {
  public static final String NAME = "ContentS3Controller";
  public static final String DESCRIPTION = "REST API for ContentS3Controller";
